...
import { Check, CheckIcon, ChevronRight, Circle, Square, SquareCheck } from "lucide-react"
...
>(({ className, children, checked, ...props }, ref) => (
  ...
  {checked ? <SquareCheck className="w-[28px] h-[28px]" />:<Square className="w-[28px] h-[28px]" />}
