...
export const LeaderboardGraph: React.FC<LeaderboardChartProps> = ({
  ...
  if (!data || data.length === 0) {
    return (
      <GraphCard className="w-full  max-w-full 3xl:max-w-[800px] min-w-[486px] flex flex-col">
  ...
  return (
    <GraphCard className="w-full max-w-full 3xl:max-w-[800px] h-[500px] min-w-[486px] flex flex-col basis-1/3">
      <CardHeader className="pb-0">
