    ...
    <>
      ...
      {isLoggedIn ? (
        <div className="flex flex-col items-center pt-20">
          <h1 className="text-6xl text-muted mb-8">
            Welcome Back,
        ...
        <div className="flex flex-col items-center pt-20">
          ...
          <p className="text-center text-lg text-git-text-secondary mb-8">
            Quick Git metrics for overworked TAs
          </p>
          <GitRepoInputSection />
          <p className="text-center text-lg text-git-text-secondary mt-8">
